...
class __$$GenreModelImplCopyWithImpl<$Res>
    extends _$PostModelCopyWithImpl<$Res, _$GenreModelImpl>
...
class _$GenreModelImpl implements _GenreModel {
  _$GenreModelImpl({this.userId, this.id, this.title, this.body});
...
abstract class _GenreModel implements PostModel {
  factory _GenreModel(
      {final int? userId,
      final int? id,
      final String? title,
      final String? body}) = _$GenreModelImpl;
